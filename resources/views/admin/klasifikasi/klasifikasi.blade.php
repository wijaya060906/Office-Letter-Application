        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Klasifikasi</h4>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Tombol Edit -->
                                <a href="{{ route('klasifikasi.edit', $item->id) }}" class="btn btn-sm btn-primary">
