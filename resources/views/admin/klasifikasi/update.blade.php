        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Update Klasifikasi</h4>
                <div class="row">
                  <div class="col-md-6">
                    <div class="card mb-4">
                      <h5 class="card-header">Form Update Klasifikasi</h5>
                      <div class="card-body">
                        <!-- Form mulai di sini -->
                        <form action="{{ route('klasifikasi.update', $klasifikasi->id) }}" method="POST">
                            @csrf
                            @method('PUT')<!-- CSRF Token -->
