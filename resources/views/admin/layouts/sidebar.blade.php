    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">BPS</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <!-- Tables -->
          <li class="menu-item">
            <a href="{{route('admin.klasifikasi')}}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-table"></i>
              <div data-i18n="Tables">klasifikasi</div>
            </a>
          </li>

          <li class="menu-item">
            <a href="{{route('admin.surattugas.surattugas')}}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-file"></i>
              <div data-i18n="Tables">Surat Tugas</div>
            </a>
          </li>
