                        ...
                        <tr>
                            ...
                            <td>
                                @if (is_null($item->file_surat))
                                    <form action="{{ route('surat.upload', $item->id) }}" method="POST" enctype="multipart/form-data" id="uploadForm-{{ $item->id }}">
                                        @csrf
                                        <label for="file_surat-{{ $item->id }}" class="btn btn-sm btn-primary d-flex align-items-center">
                                            <i class="bx bx-upload"></i> Pilih File
                                        </label>
                                        <input type="file" name="file_surat" id="file_surat-{{ $item->id }}" class="d-none" onchange="document.getElementById('uploadForm-{{ $item->id }}').submit();" required>
                                    </form>
                                @else
